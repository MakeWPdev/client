...
class Insights {
	...
	public function __construct( $client, $name = null, $file = null ) {
		...
		if ( is_object( $client ) && is_a( $client, 'Makewpdev\Client' ) ) {
			$this->client = $client;
		}
	}
	...
	private function is_local_server() {
		...
		return apply_filters( 'makewpdev_is_local', $is_local );
	}
	...
	public function admin_notice() {
		...
		if ( ! $this->is_local_server() ) {
			...
			$policy_url = 'https://' . 'makewp.dev/privacy-policy/';
			...
			$notice .= 'We are using MakeWP to collect your data. <a href="' . $policy_url . '">Learn more</a> about how MakeWP collects and handle your data.</p>';
