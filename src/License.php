...
class License {
    ...
    public function __construct( Client $client ) {
        ...
        $this->option_key = 'makewp_' . md5( $this->client->slug ) . '_manage_license';
    ...
    public function menu_output() {
        ...
        <div class="wrap makewp-license-settings-wrapper">
            <h1>License Settings</h1>

            <?php
            $this->show_license_page_notices();
            do_action( 'before_makewp_license_section' );
            ?>

            <div class="makewp-license-settings makewp-license-section">
                <?php $this->show_license_page_card_header(); ?>

                <div class="makewp-license-details">
            ...
            </div> <!-- /.makewp-license-settings -->


            <?php do_action( 'after_makewp_license_section' ); ?>
        </div>
        <?php
    }
    ...
    private function licenses_style() {
        ?>
        <style type="text/css">
            .makewp-license-section {
                width: 100%;
                max-width: 1100px;
                min-height: 1px;
                box-sizing: border-box;
            }
            .makewp-license-settings {
            ...
            .makewp-license-title svg {
                width: 30px;
                height: 30px;
                fill: #0082BF;
            }
            .makewp-license-title span {
                font-size: 17px;
                color: #444444;
                margin-left: 10px;
                font-weight: bold;
    ...
    private function show_license_page_notices() {
        if ( ! empty( $this->error ) ) :
            ?>
            <div class="notice notice-error is-dismissible makewp-license-section">
        ...
        if ( ! empty( $this->success ) ) :
            ?>
            <div class="notice notice-success is-dismissible makewp-license-section">
    ...
    private function show_license_page_card_header() {
        ?>
        <div class="makewp-license-title">
